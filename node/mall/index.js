...
async function sendMail(words) {
  let user = "2292483588@qq.com"
  let pass = "ijbpaupzohogdifg"; //  授权码
  let to = "2730217330@qq.com";
...
// sendMail();
schedule.scheduleJob({hour: 11,minuter:57},function(){
